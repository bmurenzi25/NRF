        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h4>Add & View Trainings</h4>
                        <span>Use the form below to add new trainings</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="card" style="padding: 20px;">
                ...
                <div class="card-block">
                    ...
                    @endif
                    <form wire:submit.prevent="saveTraining" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Title*</label>
                            <div class="col-sm-10">
                                <input type="text" wire:model="title" class="form-control form-control-round form-control-lg" placeholder="Training title">
                        ...
                        <div style="padding: 30px;">
                            <button type="submit" class="btn btn-outline-primary btn-lg">Save Training</button>
                        </div>
                        @else
                        <div style="padding: 30px;">
                            <button type="submit" id="submit" class="btn btn-outline-success btn-lg">Edit Training</button>
                        </div>
                        @endif
                </div>
                </form>
                ...
                <div class="table-responsive" style="padding: 25px;">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">
                                    <img src="{{ asset('uploads/data/'.$training->image) }}" alt="" width="50">
                                </th>
