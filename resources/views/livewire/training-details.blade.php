            ...
            <div class="container py-lg-5 py-md-4">
                <div class="w3breadcrumb-gids">
                    <div class="w3breadcrumb-left text-left">
                        <h2 class="title AboutPageBanner">{{ $training->title }}</h2>
                ...
                <div class="row">
                    <div class="col-lg-8 bloghnypage-left blog-single-post">
                        <div class="single-post-image mb-4">
                            <img src="{{ asset('uploads/data/'. $training->image) }}" class="img-fluid w-100 radius-image" alt="blog-post-image">
                        </div>
                        <div class="blo-singl mb-5">
                            <ul class="blog-single-author-date d-sm-flex align-items-center">
                                <li>
                                    <p><span class="fas fa-clock"></span> {{ $training->created_at->toDateString() }}</p>
                                </li>
                            </ul>
                        </div>
                        <div class="single-post-content">
                            <h3 class="post-content-title mb-3">{{ $training->title }}
                            </h3>
                            ...
                            <div class="sidebar-widget popular-posts mb-5">
                                ...
                                @forelse($recents as $recent)
                                    <article class="post">
                                        ...
                                        <div class="text"><a href="/trainings/{{ $recent->slug }}">{{ $recent->title }}</a>
                                        </div>
